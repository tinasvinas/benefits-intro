...
const PRIMARY_NAV = [
  ...
  { key:'training-center', name:'实训课程', icon:'book', children:[
    // { key:'training', name:'智能体实训', href:'pages/agent-training.html', icon:'book' },
    { key:'course-resource', name:'课程中心', href:'pages/course-center.html', icon:'layers' },
    { key:'wb-training-home', name:'我的实训', href:'pages/my-training.html', icon:'monitor' },
  ]},
  { key:'agent-dev', name:'智能体开发', icon:'cube', children:[
    { key:'agent-dev-create', name:'新增智能体', href:'pages/agent-development.html', icon:'cube' },
    { key:'agent-dev-my', name:'我的智能体', href:'pages/agent-development.html', icon:'user' },
    { key:'agent-dev-db', name:'数据库', href:'pages/agent-database.html', icon:'database' },
  ]},
  { key:'agent-use', name:'智能体使用', href:'pages/agent-use.html', icon:'chat' },
  { key:'forum', name:'学习论坛', href:'pages/learning-forum.html', icon:'forum' },
  { key:'teaching', name:'教学管理', icon:'dashboard', children:[
    { key:'workbench', name:'工作台', href:'pages/teaching-workbench.html', icon:'dashboard' },
    { key:'unjoined', name:'未入班', href:'pages/unjoined-class.html', icon:'users' },
    { key:'course', name:'课程管理', href:'pages/course-management.html', icon:'list' },
    { key:'classmgr', name:'班级管理', href:'pages/class-management.html', icon:'group' },
    { key:'myclass', name:'我的班级', href:'pages/my-classes.html', icon:'chart' },
    { key:'students', name:'学生列表', href:'pages/student-list.html', icon:'people' },
    { key:'archive', name:'学习档案', href:'pages/learning-archive.html', icon:'profile' },
    { key:'semester', name:'学期管理', href:'pages/semester-management.html', icon:'calendar' },
  ]},
  { key:'system', name:'系统管理', icon:'cpu', children:[
    { key:'school', name:'学校管理', href:'pages/school-management.html', icon:'building' },
    { key:'account', name:'账户管理', href:'pages/account-management.html', icon:'user' },
    { key:'org', name:'组织管理', href:'pages/organization-management.html', icon:'tree' },
    { key:'model', name:'模型管理', href:'pages/model-management.html', icon:'cpu' },
    { key:'tool', name:'工具管理', href:'pages/tool-management.html', icon:'wrench' },
  ]},
  { key:'operations', name:'权益与运营', icon:'crown', children:[
    { key:'benefits', name:'我的权益', href:'pages/my-benefits.html', icon:'crown' },
    { key:'cockpit', name:'全局驾驶舱', href:'pages/global-cockpit.html', icon:'screen' },
  ]},
];
